...
import com.example.rainfallapp.databinding.ActivityGooglemapBinding;
...
public class GooglemapActivity extends AppCompatActivity {
    ...
    private void listeners() {
        ...
        binding.btnProceed.setOnClickListener(v -> {
            if (locationModel != null) {
                ...
                intent.putExtra(Constants.LOCATION_DATA, locationModel);
                setResult(Constants.GET_LOCATION, intent);
                finish();
            } else {
                Utils.showShortToast(GooglemapActivity.this, "Please select location");
            }
        });
    ...
    private void displayMarker(double lat, double lon) throws IOException {
        ...
        googleMap.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker marker) {
                ...
                String addressString = Utils.getCompleteAddressString(GooglemapActivity.this, latLng.latitude, latLng.longitude);
    ...
    private LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            try {
                ...
                Log.v("TestingNewLoc", "IOException: " + e.getMessage());
                e.printStackTrace();
            }
        }
    };
    ...
    private void enableLocation() {
        ...
        Task<LocationSettingsResponse> result = LocationServices.getSettingsClient(Objects.requireNonNull(GooglemapActivity.this))
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == LOCATION_PERMISSIONS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                if (ContextCompat.checkSelfPermission(Objects.requireNonNull(GooglemapActivity.this),
